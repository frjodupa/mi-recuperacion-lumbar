  ...
  return (
    <header className="no-print mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <ThemeSelector value={theme} onChange={onThemeChange} compact />
        <div className="hidden items-center gap-2 rounded-2xl border border-app-border bg-app-surface/80 px-4 py-2.5 text-sm font-semibold text-petrol-700 shadow-card backdrop-blur-xl sm:flex">
